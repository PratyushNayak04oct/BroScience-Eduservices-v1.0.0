...
// The two page meshes do not meet at the spine — each content plane starts at
// local x=0.0152 of a 0.9728 half-width, so 1.56% of the spread is swallowed by
// the fold. Dropping that centre strip is what keeps the straddling quote and
// footer aligned across the gutter instead of visibly stepping.
const FOLD_PX = Math.round(SPREAD_W * 0.0156);
